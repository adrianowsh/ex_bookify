...
images_url = "#{ExBookifyWeb.Endpoint.url()}/images"
...
%Place{
  ...
  bookings: [
    %Booking{
      start_date: ~D[2024-10-18],
      end_date: ~D[2024-10-21],
...
%Place{
  ...
  reviews: [
    %Review{
      ...
      rating: 5,
      user: nicole,
      inserted_at: DateTime.from_naive!(~N[2024-03-26 22:00:00], "Etc/UTC")
    }
  ]
}
|> Repo.insert!()
...
%Place{
  ...
  reviews: [
    %Review{
      ...
      rating: 5,
      user: mike,
      inserted_at: DateTime.from_naive!(~N[2024-03-15 22:00:00], "Etc/UTC")
    },
    %Review{
      comment: "Enjoyed some absinthe on the dock. 🍹",
      rating: 4,
      user: beachbum,
      inserted_at: DateTime.from_naive!(~N[2024-03-21 09:00:00], "Etc/UTC")
    },
    %Review{
...
%Place{
  ...
  bookings: [
    ...
    %Booking{
      start_date: ~D[2024-11-10],
      end_date: ~D[2024-11-20],
